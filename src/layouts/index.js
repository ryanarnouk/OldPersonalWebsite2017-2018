  ...
  <div className="rightbar portfolio"> 
    <div>
      ...
      <div className="portfolioblocks">
        ...
        <PortfolioBlock name="My Blog" info={<p className="portfolioinfo" style={{fontSize: '0.5em'}}>Check out my blog application. I try to write articles and post them and you can check them out <a target="_blank" href="https://azbo400.github.io/Blog">here</a></p>} source={require('../../public/img/blogapp.png')} styling={{width: 160}}/>
